  ...
  return (
    <>
      ...
      {setShowBill && (
        <>
          <Row>
            <div className=" basicbox col-3 col-md-5 col-lg-5 col-xl-5">
      ...
      ></Link> */}
          ...
          >  */}
          <div style={{ overflowY: "scroll", maxHeight: "300px", marginTop: "80px",marginLeft: "50px"}}>
              ...
              <div key={index} >
                ...
                <p className="basicfields">Special Allowances</p>
                  ...
                  <p className="basicfields">Extra Allowances</p>
                        <p className="basicdata">
                        {allowanceData.extraAllowance}&nbsp;</p>
      ...
      {showClients && (
        <>
          <div style={{ overflowY: "scroll", maxHeight: "400px", marginTop: "50px",marginLeft: "50px"}}>
      ...
      {showEmployees && (
        ...
        >
          {employee?.map((emp, index) => (
            <div className="basicbox col-12 col-md-8 col-lg-8 col-xl-8" key={index}>
              <Row >
              <Col md={1}>
                <img src="" className="emppic"  />
              </Col>
              <Col md={2} style={{marginLeft: "53px",
    marginTop: "14px"}}>
                <p className="basicdata">
                  {emp.firstName}
                  {emp.lastName}
              ...
              <Col md={1} style={{marginLeft: "53px",
    marginTop: "14px"}}>
